   ...
   <div class="body__wrapper">
       <div class="content__wrapper">
           ...
           <div class="info__wrapper">
                <form name="adminUpdateProfileForm" method="POST" action="/storage/profile">
                   <ul class="info__list">
                       ...
                       <li class="info__item">
                           ...
                           <div class="info__blocked-field">
                               <input type="text" name="fullName" value="${profile.get(0).getFullName()}" required>
                       ...
                       <li class="info__item">
                           ...
                           <input type="hidden" name="status" value="${profile.get(0).getStatus()}" />
                           <c:choose>
                               <c:when test="${profile.get(0).getStatus() eq 'blocked'}">
                                   <input type="submit" name="blockSubmit" value="Unblock account">
                               </c:when>
                               <c:otherwise>
               ...
               <!--<form name="moderatorBlockProfileForm" method="POST" action="/storage/user-list">
                    <input type="hidden" name="command" value="block_user" />
                    <input type="hidden" name="identifier" value="${profile.get(0).getIdentifier()}" />
                    <input type="submit" name="blockSubmit" value="Block account" class="info__extra-submit">
               </form>-->
           </div>
       </div>
   </div>
